...
The hosted dashboard snapshot in `app/data/` is copied from this folder after refreshes, including the tournament simulation probability table and top-league roster player power table.
