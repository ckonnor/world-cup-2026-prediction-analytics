...
Feature models are model-ready outputs. Downstream Python consumes these tested dbt tables instead of rebuilding raw CSV joins inside model-training code.
