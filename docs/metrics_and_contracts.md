...
| `dashboard_player_power_profiles.csv` | One row per squad player | Roster players include team, position, caps, international goals, club involvement, card context, and player star-power proxy. |
