...
| `dashboard_player_power_profiles.csv` | One row per squad player | Roster player power proxy, international caps/goals, matched club minutes, goals, assists, and card context |
